...
<# Begin: DataSource "exchange-on-premises-distribution-group-delete | Exchange-On-Premises-Get-DistributionGroup-Wildcard-Name-Alias" #>
$tmpPsScript = @'
...
'@ 
$tmpModel = @'
[{"key":"Guid","type":0},{"key":"DisplayName","type":0},{"key":"Name","type":0},{"key":"Alias","type":0},{"key":"PrimarySmtpAddress","type":0},{"key":"EmailAddresses","type":0},{"key":"DistinguishedName","type":0}]
'@ 
$tmpInput = @'
...
exchange-on-premises-distribution-group-delete | Exchange-On-Premises-Get-DistributionGroup-Wildcard-Name-Alias
'@ 
...
<# End: DataSource "exchange-on-premises-distribution-group-delete | Exchange-On-Premises-Get-DistributionGroup-Wildcard-Name-Alias" #>
<# End: HelloID Data sources #>

<# Begin: Dynamic Form "Exchange On-Premises - Distribution Group - Delete" #>
$tmpSchema = @"
[{"key":"searchGroup","templateOptions":{"label":"Search Distributiongroup","required":true},"type":"input","summaryVisibility":"Show","requiresTemplateOptions":true,"requiresKey":true,"requiresDataSource":false},{"key":"gridGroup","templateOptions":{"label":"Select Distributiongroup","required":true,"grid":{"columns":[{"headerName":"Display Name","field":"DisplayName"},{"headerName":"Primary Smtp Address","field":"PrimarySmtpAddress"},{"headerName":"Distinguished Name","field":"DistinguishedName"}],"height":300,"rowSelection":"single"},"dataSourceConfig":{"dataSourceGuid":"$dataSourceGuid_0","input":{"propertyInputs":[{"propertyName":"searchValue","otherFieldValue":{"otherFieldKey":"searchGroup"}}]}},"useFilter":true,"useDefault":false,"allowCsvDownload":true},"type":"grid","summaryVisibility":"Show","requiresTemplateOptions":true,"requiresKey":true,"requiresDataSource":true}]
"@ 

$dynamicFormGuid = [PSCustomObject]@{} 
$dynamicFormName = @'
Exchange On-Premises - Distribution Group - Delete
'@ 
